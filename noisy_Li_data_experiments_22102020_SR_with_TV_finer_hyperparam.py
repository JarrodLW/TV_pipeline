...
if run_exp:
    ...
    json.dump(regularised_recons, open('dTV/Results_MRI_dTV/TV_recons_multiple_avgs_22102020_SR_finer_hyperparam.json', 'w'))

if plot_results:

    with open('dTV/Results_MRI_dTV/TV_recons_multiple_avgs_22102020_SR_finer_hyperparam.json') as f:
        d = json.load(f)
