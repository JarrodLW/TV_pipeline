...
if discrepancy_plots:
    ...
    with open('/Users/jlw31/Desktop/Results_on_15032021_dataset/TV/TV_H_SSIM_vals.json') as f:
    ...
    for k, avg in enumerate(avgs):
        ...
        plt.errorbar(np.log10(np.asarray(reg_params))[1:], np.average(H_SSIM_arr[1:], axis=1),
...
if hyperparam_sweep_resuls:
    ...
    with open(
            save_dir + 'dTV_pre_registered/dTV_7Li_15032021_1024_pre_registered_hyper_search_gamma_9.0e-01.json') as f:
        d1 = json.load(f)
    f.close()

    with open(
            save_dir + 'dTV_pre_registered/dTV_7Li_15032021_1024_pre_registered_hyper_search_gamma_9.3e-01.json') as f:
        d2 = json.load(f)
    f.close()

    with open(
            save_dir + 'dTV_pre_registered/dTV_7Li_15032021_1024_pre_registered_hyper_search_gamma_9.5e-01.json') as f:
        d3 = json.load(f)
    f.close()

    with open(
            save_dir + 'dTV_pre_registered/dTV_7Li_15032021_1024_pre_registered_hyper_search_gamma_9.7e-01.json') as f:
        d4 = json.load(f)
    f.close()

    with open(
            save_dir + 'dTV_pre_registered/dTV_7Li_15032021_1024_pre_registered_hyper_search_gamma_9.9e-01.json') as f:
        d5 = json.load(f)
    f.close()
