...
for ele in range(0, len(f_coeff_list), 2):
    f_coeff_list_grouped.append(f_coeff_list[ele] + f_coeff_list[ele + 1])
...
if run_exp:
    ...
    json.dump(regularised_recons,
              open('dTV/Results_MRI_dTV/Robustness_31112020_TV_1024.json', 'w'))
